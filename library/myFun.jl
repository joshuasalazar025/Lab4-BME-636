module myFun
    ...
    @everywhere function MRIscan(T2valueForM1::Float64,T2valueForM2::Float64,T2valueForM3::Float64,FrequencyGradientForM2::Array{Float64},FrequencyGradientForM3::Array{Float64},FOV::Float64,DW::Float64,matrixSizeX::Int64,matrixSizeY::Int64,TE::Float64,NoiseLevel::Float64)
        ...
        tmp1 = repmat((-64.:63.)*FrequencyGradientForM2[1]/vx,1,128);
        tmp2 = repmat((-64.:63.)'*FrequencyGradientForM2[2]/vy,128,1);
        B0offsetForM2 = tmp1+tmp2;
        tmp1 = repmat((-64.:63.)*FrequencyGradientForM3[1]/vx,1,128);
        tmp2 = repmat((-64.:63.)'*FrequencyGradientForM3[2]/vy,128,1);
        B0offsetForM3 = tmp1+tmp2;
        B0offsetmap = zeros(128,128); B0offsetmap[find(m2.>=2)]=B0offsetForM2[find(m2.>=2)]; B0offsetmap[find(m3.>=3)]=B0offsetForM3[find(m3.>=3)]; 
